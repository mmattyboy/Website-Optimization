  ...
  switch(size) {
    ...
    case "3":
      newwidth = 50;
       break;
     default:
      console.log("Bug in changing pizza size");
  }
...
//read the changing value of the class mover
  var scrollValue = document.body.scrollTop;
  for (var i = 0; i < items.length; i++) {
// write the value now to avoid synchronous layout
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var pizzasOnScreen = (screen.height / s) * cols;
